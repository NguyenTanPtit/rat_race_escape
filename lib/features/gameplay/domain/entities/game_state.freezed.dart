...
// 2. Financials (Must be initialized depending on context)
 ...
 String? get currentEventId; Set<String> get flags; Set<String> get unlockedInsightCardIds; double get familySupportExpense; double get baseEventChance; int get bankruptcyMonthsThreshold; double get leisureCostPerStressPoint; int get maxLeisureStressReliefPerMonth; int get leisureReliefUsedThisMonth;// 6. Inventories
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,country,currency,scenarioId,currentMonth,ageInMonths,startCalendarMonth,cash,monthlyExpenses,monthlyRent,baseSalary,stress,networkScore,creditScore,housingLevel,const DeepCollectionEquality().hash(ownedItems),currentEventId,const DeepCollectionEquality().hash(flags),const DeepCollectionEquality().hash(unlockedInsightCardIds),familySupportExpense,baseEventChance,bankruptcyMonthsThreshold,leisureCostPerStressPoint,maxLeisureStressReliefPerMonth,leisureReliefUsedThisMonth,const DeepCollectionEquality().hash(assets),const DeepCollectionEquality().hash(loans)]);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,country,currency,scenarioId,currentMonth,ageInMonths,startCalendarMonth,cash,monthlyExpenses,monthlyRent,baseSalary,stress,networkScore,creditScore,housingLevel,const DeepCollectionEquality().hash(_ownedItems),currentEventId,const DeepCollectionEquality().hash(_flags),const DeepCollectionEquality().hash(_unlockedInsightCardIds),familySupportExpense,baseEventChance,bankruptcyMonthsThreshold,leisureCostPerStressPoint,maxLeisureStressReliefPerMonth,leisureReliefUsedThisMonth,const DeepCollectionEquality().hash(_assets),const DeepCollectionEquality().hash(_loans)]);
