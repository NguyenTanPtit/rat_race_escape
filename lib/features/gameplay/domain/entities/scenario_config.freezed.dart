...
mixin _$ScenarioConfig {
 ...
 String get id; double get initialCash; double get baseSalary; double get monthlyRent; double get monthlyExpenses; List<Asset> get initialAssets; List<Loan> get initialLoans; double get familySupportExpense; int get startAgeInMonths; int get startCalendarMonth; int get initialCreditScore; HousingLevel get housingLevel; Country get country; String get currency; int get bankruptcyMonthsThreshold; double get leisureCostPerStressPoint; int get maxLeisureStressReliefPerMonth; double get baseEventChance; double get sideJobIncome; int get sideJobStress; int get maxSideJobsPerMonth; double get assetSellFeeRate; List<MarketClassConfig> get marketClasses; double get healthInsurancePremiumMonthly;// 0 = insurance not offered
 double get inflationAnnualRate;// 0 = no inflation in this scenario
 double get salaryGrowthAnnualRate; double get savingsAnnualRate;// decimal; 0 = bank not offered
 double get bankLoanAnnualRate;// % per year; 0 = lending not offered
 int get bankLoanMinCredit; double get bankLoanMaxLtv; List<CourseConfig> get courses;
...
@useResult
$Res call({
 String id, double initialCash, double baseSalary, double monthlyRent, double monthlyExpenses, List<Asset> initialAssets, List<Loan> initialLoans, double familySupportExpense, int startAgeInMonths, int startCalendarMonth, int initialCreditScore, HousingLevel housingLevel, Country country, String currency, int bankruptcyMonthsThreshold, double leisureCostPerStressPoint, int maxLeisureStressReliefPerMonth, double baseEventChance, double sideJobIncome, int sideJobStress, int maxSideJobsPerMonth, double assetSellFeeRate, List<MarketClassConfig> marketClasses, double healthInsurancePremiumMonthly, double inflationAnnualRate, double salaryGrowthAnnualRate, double savingsAnnualRate, double bankLoanAnnualRate, int bankLoanMinCredit, double bankLoanMaxLtv, List<CourseConfig> courses
});
...
as double,marketClasses: null == marketClasses ? _self.marketClasses : marketClasses // ignore: cast_nullable_to_non_nullable
as List<MarketClassConfig>,healthInsurancePremiumMonthly: null == healthInsurancePremiumMonthly ? _self.healthInsurancePremiumMonthly : healthInsurancePremiumMonthly // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey() final  double assetSellFeeRate;
 final  List<MarketClassConfig> _marketClasses;
@override@JsonKey() List<MarketClassConfig> get marketClasses {
  if (_marketClasses is EqualUnmodifiableListView) return _marketClasses;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_marketClasses);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ScenarioConfig&&(identical(other.id, id) || other.id == id)&&(identical(other.initialCash, initialCash) || other.initialCash == initialCash)&&(identical(other.baseSalary, baseSalary) || other.baseSalary == baseSalary)&&(identical(other.monthlyRent, monthlyRent) || other.monthlyRent == monthlyRent)&&(identical(other.monthlyExpenses, monthlyExpenses) || other.monthlyExpenses == monthlyExpenses)&&const DeepCollectionEquality().equals(other._initialAssets, _initialAssets)&&const DeepCollectionEquality().equals(other._initialLoans, _initialLoans)&&(identical(other.familySupportExpense, familySupportExpense) || other.familySupportExpense == familySupportExpense)&&(identical(other.startAgeInMonths, startAgeInMonths) || other.startAgeInMonths == startAgeInMonths)&&(identical(other.startCalendarMonth, startCalendarMonth) || other.startCalendarMonth == startCalendarMonth)&&(identical(other.initialCreditScore, initialCreditScore) || other.initialCreditScore == initialCreditScore)&&(identical(other.housingLevel, housingLevel) || other.housingLevel == housingLevel)&&(identical(other.country, country) || other.country == country)&&(identical(other.currency, currency) || other.currency == currency)&&(identical(other.bankruptcyMonthsThreshold, bankruptcyMonthsThreshold) || other.bankruptcyMonthsThreshold == bankruptcyMonthsThreshold)&&(identical(other.leisureCostPerStressPoint, leisureCostPerStressPoint) || other.leisureCostPerStressPoint == leisureCostPerStressPoint)&&(identical(other.maxLeisureStressReliefPerMonth, maxLeisureStressReliefPerMonth) || other.maxLeisureStressReliefPerMonth == maxLeisureStressReliefPerMonth)&&(identical(other.baseEventChance, baseEventChance) || other.baseEventChance == baseEventChance)&&(identical(other.sideJobIncome, sideJobIncome) || other.sideJobIncome == sideJobIncome)&&(identical(other.sideJobStress, sideJobStress) || other.sideJobStress == sideJobStress)&&(identical(other.maxSideJobsPerMonth, maxSideJobsPerMonth) || other.maxSideJobsPerMonth == maxSideJobsPerMonth)&&(identical(other.assetSellFeeRate, assetSellFeeRate) || other.assetSellFeeRate == assetSellFeeRate)&&const DeepCollectionEquality().equals(other._marketClasses, _marketClasses)&&(identical(other.healthInsurancePremiumMonthly, healthInsurancePremiumMonthly) || other.healthInsurancePremiumMonthly == healthInsurancePremiumMonthly)&&(identical(other.inflationAnnualRate, inflationAnnualRate) || other.inflationAnnualRate == inflationAnnualRate)&&(identical(other.salaryGrowthAnnualRate, salaryGrowthAnnualRate) || other.salaryGrowthAnnualRate == salaryGrowthAnnualRate)&&(identical(other.savingsAnnualRate, savingsAnnualRate) || other.savingsAnnualRate == savingsAnnualRate)&&(identical(other.bankLoanAnnualRate, bankLoanAnnualRate) || other.bankLoanAnnualRate == bankLoanAnnualRate)&&(identical(other.bankLoanMinCredit, bankLoanMinCredit) || other.bankLoanMinCredit == bankLoanMinCredit)&&(identical(other.bankLoanMaxLtv, bankLoanMaxLtv) || other.bankLoanMaxLtv == bankLoanMaxLtv)&&const DeepCollectionEquality().equals(other._courses, _courses));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,initialCash,baseSalary,monthlyRent,monthlyExpenses,const DeepCollectionEquality().hash(_initialAssets),const DeepCollectionEquality().hash(_initialLoans),familySupportExpense,startAgeInMonths,startCalendarMonth,initialCreditScore,housingLevel,country,currency,bankruptcyMonthsThreshold,leisureCostPerStressPoint,maxLeisureStressReliefPerMonth,baseEventChance,sideJobIncome,sideJobStress,maxSideJobsPerMonth,assetSellFeeRate,const DeepCollectionEquality().hash(_marketClasses),healthInsurancePremiumMonthly,inflationAnnualRate,salaryGrowthAnnualRate,savingsAnnualRate,bankLoanAnnualRate,bankLoanMinCredit,bankLoanMaxLtv,const DeepCollectionEquality().hash(_courses)]);
...
as int,maxSideJobsPerMonth: null == maxSideJobsPerMonth ? _self.maxSideJobsPerMonth : maxSideJobsPerMonth // ignore: cast_nullable_to_non_nullable
as int,assetSellFeeRate: null == assetSellFeeRate ? _self.assetSellFeeRate : assetSellFeeRate // ignore: cast_nullable_to_non_nullable
as double,marketClasses: null == marketClasses ? _self._marketClasses : marketClasses // ignore: cast_nullable_to_non_nullable
as List<MarketClassConfig>,healthInsurancePremiumMonthly: null == healthInsurancePremiumMonthly ? _self.healthInsurancePremiumMonthly : healthInsurancePremiumMonthly // ignore: cast_nullable_to_non_nullable
as double,inflationAnnualRate: null == inflationAnnualRate ? _self.inflationAnnualRate : inflationAnnualRate // ignore: cast_nullable_to_non_nullable
as double,salaryGrowthAnnualRate: null == salaryGrowthAnnualRate ? _self.salaryGrowthAnnualRate : salaryGrowthAnnualRate // ignore: cast_nullable_to_non_nullable
as double,savingsAnnualRate: null == savingsAnnualRate ? _self.savingsAnnualRate : savingsAnnualRate // ignore: cast_nullable_to_non_nullable
